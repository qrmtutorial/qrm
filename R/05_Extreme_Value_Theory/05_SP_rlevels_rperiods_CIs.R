...
ll<-uniroot(rootfunc, lower = 2, upper = rlevel.10year, data = M.year, period = 10,
            global.max = global.max.a, alpha = alpha)
ll
ML.H0(M.year, 10, ll$root)
uu <-uniroot(rootfunc, lower = rlevel.10year, upper = 15, data = M.year, period = 10,
             global.max = global.max.a, alpha = alpha)
uu
...
ll<-uniroot(rootfunc, lower = 4, upper = rlevel.50year, data = M.year, period = 50,
            global.max = global.max.a, alpha = alpha)
ll
ML.H0(M.year,50,ll$root)
uu <-uniroot(rootfunc, lower = rlevel.50year, upper = 25, data = M.year, period = 50,
             global.max = global.max.a, alpha = alpha)
uu
...
ll<-uniroot(rootfunc, lower = 10, upper = rperiodBM.annual, data = M.year, level = BlackMonday,
            global.max = global.max.a, alpha = alpha)
ll
...
for (i in 1:length(pwr)){
    profile[i]<-rootfunc(level = BlackMonday, data = M.year, period = 10^pwr[i],
                         global.max = global.max.a, alpha = alpha)
}
...
ll<-uniroot(rootfunc, lower = 2, upper = rlevel.20semester, data = M.halfyear, period = 20,
            global.max = global.max.b, alpha = alpha)
ll
ML.H0(M.halfyear,20,ll$root)
uu <-uniroot(rootfunc, lower = rlevel.20semester, upper = 15, data = M.halfyear, period = 20,
             global.max = global.max.b, alpha = alpha)
uu
...
ll<-uniroot(rootfunc, lower = 10, upper = rperiodBM.semester, data = M.halfyear,
            level = BlackMonday, global.max = global.max.b, alpha = alpha)
ll
ML.H0(M.halfyear,ll$root,BlackMonday)
uu <-uniroot(rootfunc, lower = rperiodBM.semester, upper = 10^8, data = M.halfyear,
             level = BlackMonday, global.max = global.max.b, alpha = alpha)
uu
